            ...
            [
              ...
              [
                ...
                [
                  ...
                  [
                    'How much progress have you made on the optimization of the game? Will there be more and more detailed physics settings?',
                    'Since release, we\'ve made a ton of optimizations and still have a way to go. The introduction to the gameplay option in the last update is a start to give the player more control over the game’s performance.',
                  ],
                  [
                    'Will we ever be able to free Caged Farmers for real?',
                    'Well, you free them by bringing them back to the Farmer hideout. They unlock the cages behind closed doors after that...or so we hope.',
                  ],
                  [
                    'Are you planning to fix sliding wheels? (when I have my car on any angle, it slides like butter on wheels)',
                    'We are not sure why wheels slide when parked on a slant. It\'s something we will have to investigate. We think one reason is that the wheels have pretty low friction. This is done to make driving feel nice. But it possibly comes at the cost of the vehicle sliding around too much. We will look into that further.',
                  ],
                  [
                    (
                      <>
                    ...
                    'The exosuit is still in our plans. However, it will look different than the concepts we\'ve shown. It will also not be included in the next chapter. Maybe the one after that.',
                  ],
                  [
                    'When will we be able to have a dedicated server, so one PC doesn\'t have to run at all times for friends to progress independently?',
                    'The problem is that the server will use too much processing power to calculate the physics. It might be a possibility if the players would host it themselves. We get a lot of requests about this, so we will investigate it further. But it\'s tricky with a physics-heavy game like Scrap Mechanic.',
                  ],
                  [
                    'Will we ever be able to use the Indoor Grow-Beds you have had in Scrap Mechanic since Creative, so we can put the crops inside of our bases?',
                    'Yes, we see a lot of use for Indoor Grow-Beds so it\'s very likely going to get added.',
                  ],
                  [
                    'A common sentiment in the community is that while oil pools eliminated the tedium of the geysers, they\'ve made oil collecting way too easy and similar to how chemicals are obtained. Are oil pools just a temporary thing until a more interesting oil mechanic is introduced?',
                    'We don\'t have any plans to change it right now. But we make sure to listen to player feedback. So if something is requested a lot, then we will change it.',
                  ],
                  [
                    'Is there going to be spud gun customization in the future?',
                    'That was the plan from the beginning, but we have had to put this on hold. We just don\'t see spud gun customization making a lot of sense right now. We think that the ones that are in the game do a good job of covering different types of situations. But it\'s not impossible that we will bring it back later, as we add new bots to fight.',
                  ],
                  [
                    'Will you have to start a new Survival world when chapter 2 comes out and if you don\'t, will you be missing anything that you would get with a new world?',
                    'We really want to avoid this. We want players to be able to use their old Survival worlds with the next chapter right away without missing out on anything.',
                  ],
                  [
                    'There are a bunch of exploits players use in Survival that completely break the game. Are you planning to do anything about that?',
                    'We are not sure what exploits are referring to. But if the players want to exploit the game and break things because they think it\'s fun, then that\'s ok. It\'s their choice, as long as they are having a good time.',
                  ],
                  [
                    'A question I have is, how will you treat automation? I saw in a devblog a lot of time ago a picture where you could use vacuum pumps to move gas into a canister. I\'d love to see a funnel pipe of some sort to shoot items into from a vacuum pump, like the packing station.',
                    'With the release of Survival Mode, we noticed that a lot of players were really enjoying the automation part of the game and wanted more. Shooting items into a container or a chest from separate creations is something that we will look into. We always wanted players to build their own automated gas stations that fill up their vehicles, for example.',
                  ],
                  [
                    'Do you plan on making a way to harvest glue in bulk, just like you did with oil? Currently, it takes quite a lot of time to swim around and gather enough shells for the project you may need it for.',
                    'Yes, the idea is to give the player ways to automate all types of resources. We have been looking into pigment flowers and clams, for example. More on that later.',
                  ],
                  [
                    'Any plans to add another game mode besides the three we already have?',
                  ...
                  [
                    'It would be nice if you could turn on health in Creative Mode.',
                    'We agree! It\'s something we should add.',
                  ],
                  [
                    'Will there be train tracks/track pieces and train wheels?',
                    'There might be, but right now there are no plans for that. However, we\'ve seen some awesome mods that have added them.',
                  ],
                  [
                    'The presence of the fridge, being unique for only containing food items, implies that food will be perishable later in development. Is this true?',
                    'No, this was never the plan. We will not make the food go old. However, we do have other plans for the fridge. More on that later.',
                  ],
                  [
                    (<a href="https://twitter.com/ScrapManYT/status/1394894719671422976">Draggable wedges when?</a>),
                    'We have gotten pretty far on draggable wedges. What we have to work out now is how they will work when you pick them up after having placed them. That is because they don’t scale and work like normal blocks. We might show them in action in the next devblog.',
                  ],
                  [
                    'Will there be a Mac version of the game?',
                    'It\'s not a priority right now. Maybe after we do console ports.',
                  ],
                  [
                    'Why do we jump randomly while driving?',
                  ...
                  [
                    'Would Steam achievements be planned in the future? It would probably invite more people to try and make interesting stuff in Survival',
                    'Yes! Once we get out of early access we will have achievements in place.',
                  ],
                  [
                    'Do you guys have any ideas for ocean-based bots? Like an oil rig or a fishing boat?',
                    'All we can say now is that one of the totebots will be ocean-based.',
                  ],
                  [
                    'Why are there no gears in the game? I think a game about mechanics should have gears',
                    'There are ways we can do gears in a pretty optimized way. It\'s just something we didn\'t prioritize. Let us know in the comments below if you would like us to add gears.',
                  ],
                  [
                    'Have you thought about adding old railroad tracks to the Survival map that players can run vehicles on? It would make for a fun way to get around, and even make mobile bases',
                    'The next chapter might include some tracks that the player can use.',
                  ],
                  [
                    'Have you ever thought about doing a collaboration with LandFall games?',
                    'Yes we have; they are good friends of ours. We have been playing with ideas, but never gotten around to working on something together yet.',
                  ],
                  [
                    'Are we going to be able to loot the warehouses in the future?',
                    'Yes! When the next chapter comes out. The player will be able to find a way to loot the warehouse.',
                  ],
                  [
                    'Will there be/are there plans to add a reload animation for the Spud Guns? (Maybe similar to the paint tool?)',
                    'We were planning to do a reload for the Spud Gun. But during development, we felt that it\'s pretty nice to be able to shoot without interruption in many cases so we left it out. A lot of mechanics are using the spud gun for other things than shooting bots.',
                  ],
                  [
                    'Are collision damage mechanics a thing we\'ll see? i.e driving your vehicle off a high cliff and crashing hard into the ground below will cause blocks/parts of it to disappear?',
                    'Probably not with the blocks that are in the game currently. Maybe we could add a special block that would break on impact, but it\'s not in the plans right now.',
                  ],
                  [
                    'When will the welder outfit be released and when will more garments be released?',
                    'We have a few new outfits ready for the next chapter, including the welder outfit and a miner outfit that we haven\'t shown yet.',
                  ],
                  [
                    'Can we please be able to destroy bushes? Some are in the way. I don\'t care if it takes 1000 metal 3 to do it, I need a bush wacker',
                    'We hear you; they can get in the way. We will look into it so you can at least cut them down.',
                  ],
                  [
                    'What is your favorite bug that the community has found?',
                    'Well, the t-pose bug when the player was running was pretty funny at times.',
                  ],
                  [
                    'I recall that you were working on birds a while back, will we see them anytime soon? Maybe new creatures?',
                    'We might add more creatures. But right now, we are focusing on adding new bots.',
                  ],
                  [
                    'When will we be able to spawn bots in Challenge mode? Thanks!',
                    'Hopefully soon. We have this pretty much working on our end. Making your own shooters with the challenge mode editor is really fun. We definitely want to add it soon.',
                  ],
                ],
              ],
              [
                ...
                [
                  [
                    ...
                    'It all started with Minecraft; at first, we were pitching a Minecraft port for the Xbox360 to our friends at Mojang back in 2011 but we never ended up partnering with them. So we decided to work on our own game within the sandbox/survival genre. Back then, we always felt like you couldn\'t really do much with the things you built in Minecraft. So we wanted to make a game where you create machines that have motion and physics. Creations that can solve problems within a game world. That\'s how it started.',
                  ],
                  [
                    'How many devs are working full-time on this game?',
                    'When we released Scrap Mechanic on Steam in 2016, we were a 3-person team. Today, the Scrap mechanic team is made up of 12 people that are working full time, not including freelance help.',
                  ],
                  [
                    'What was the biggest problem y\'all had in the beginnings of SM?',
                    'It was probably the bugs that popped up when we released Scrap Mechanic. We didn\'t expect the game to become a number 1 global top-seller on Steam when we hit the release button. We were overwhelmed with bug reports and requests from all the new players. It was a stressful time, but a happy one.',
                  ],
                  [
                    'When will you finally finish the game? It\'s been a year since Survival released and not even the second chapter is out holy crap!',
                    'Great question! Scrap Mechanic has been in development since late 2011 when we started and released on Steam in 2016. This might sound like a crazy long time, but when we started working on Scrap Mechanic, game engines like Unity were mainly used for mobile games and Unreal Engine\'s license cost was too high for us at the time. So we decided to make the game in a free engine, called Ogre Engine. It ended up limiting us a lot during development, so we decided to make our own. During development, we have been working on a Scrap Mechanic and our own game engine at the same time. This has slowed things down a lot. But we are now at a stage where we are really happy with our tools and development is going a lot faster compared to before Survival\'s release. However, we are working on pretty big updates so it still doesn\'t mean that they will be dropping at a very fast rate. Good game development still takes a lot of time. Everything has to get designed, iterated, tested, and implemented.',
                  ],
                  [
                    'When creating a new big update, how do you make sure, to the best of your ability, that it is going to keep people interested in the game?',
                    'Well, in the case of the next chapter, we usually aim to introduce a setting where the player can be creative in new ways that were not possible before. Then we try to find a lot of new ideas for interactive parts and progression within that. It\'s much more complicated than that, but that\'s how we start.',
                  ],
                  [
                    'What was Survival development like? What took so long? Did plans change while making the mode? How is it still in an unfinished state?',
                    'The thing that took the longest was the work we had to do on our game engine in order to allow us to do everything we wanted. The good news is that we are at a stage now where we are very happy with it. That was mainly the thing slowing the development down. But no more!',
                  ],
                  [
                    'Why do people who make mods for this game add new and interesting things much faster?',
                    'It\'s because of the awesome Scrap Mechanic community making really great mods. We, however, are a bit limited when adding things to Scrap Mechanic since everything has to fit the theme and have a meaning in the context of the game. We focus more on bigger updates while leaving a lot of space for mod makers to be creative.',
                  ],
                  [
                    'Devblog 22 when?',
                    'Hopefully soon. Right now, we are waiting for a few things to be more presentable. We can, however, say that it will be a pretty exciting devblog. We will show underground digging for the first time!',
                  ],
                  [
                    'How come you’ve been so inactive on Twitter for the past 2 months?',
                    'Usually when we go silent, it means that we are pretty busy with internal deadlines. But we will take it to heart and try to post more during these times.',
                  ],
                  [
                    'Why are you guys so slow with updates compared to most games today?',
                    'Development used to be very slow before the Survival release. But today, our tools are a lot better and our development is going pretty fast. However, it\'s hard to see that from the outside since the community does not see the number of things we are working on. Hopefully, the dev blogs will start to make that clearer.',
                  ],
                ],
              ],
              [
                ...
                [
                  [
                    ...
                    'We are doing great! We are busy working on some really cool features for the next chapter. We are definitely not in development hell like we\'ve seen some players think in the community.',
                  ],
                  [
                    'Is this Q & A replacing a devblog?',
                    'No! We will still do dev blogs. This Q&A is just something we have wanted to do since we noticed that there were a bunch of questions sent to us and Twitter is not really a good place to answer the longer ones.',
                  ],
                  [
                    (<a href="https://twitter.com/kan_gaming/status/1394746298679562242">What are your favorite toppings to put on a sandwich?</a>),
                    'Easy answer! The toppings on a revival baguette!',
                  ],
                ],
              ],
            ].map((group) => (
