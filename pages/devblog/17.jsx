              ...
              <div className="col-lg-9">
                ...
                `,
                  ...
                  <article>
                    ...
                    <br />
                    Anyway, we know you&#039;re here for
                    ...
                    <br />
                    Let&#039;s start with the necessary but less fun
                    ...
                    in to one.
                    <br />
                    For example, a seamless transition from the
                    ...
                    <br />
                    <br />
                    <a href="#" id="tapebots" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    The Tapebots are coming closer! We&#039;re currently
                    ...
                    them.
                    <br />
                    We hope that this less forgiving approach to
                    ...
                    <br />
                    <br />
                    <a href="#" id="upgrading" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    In the past weeks we&#039;ve been teasing some of the
                    new upgradeable interactive parts on our Twitter. Now you can
                    see them in full 3D glory!
                    <br />
                    Basically, we are working on
                    ...
                    <br />
                    <br />
                    <a href="#" id="new-lift-concept" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    When we started working on Scrap Mechanic, the lift was
                    ...
                    <br />
                    <br />
                    <a href="#" id="clothing" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    <br />
                    <a href="#" id="packing-stations" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    Say hello to Packing Stations! One way to accomplish
                    ...
                    <br />
                    <br />
                    <a href="#" id="graphics-update" style={{ display: 'block' }} aria-hidden="true" />
                    <b>
                      - Visual Spit &#039;n&#039; Polish
                    </b>
                    <br />
                    The eagle eyed among you will notice that we&#039;re
                    ...
                    <br />
                    <br />
                    <a href="#" id="new-dynamic-lights" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    <br />
                    <a href="#" id="old-part-textures" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    <br />
                    <br />
                    <a href="#" id="shiny-metal" style={{ display: 'block' }} aria-hidden="true" />
                    <LazyLoadImage
                    ...
                    – and for playing!
                    <br />
                    We will be back soon with more Scrap
                    Mechanic news!
                  </article>
                </div>
                <Comments />
