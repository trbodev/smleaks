...
export default function Devblog1(page) {
  return (
    <div>
      <Head>
      ...
      <div className="card">
        ...
        <article>
          ...
          <LazyLoadImage
            effect="blur"
            src={require('../../public/images/devblog/1/2.png?webp&url')}
            placeholderSrc={require('../../public/images/devblog/1/2.png?webp&lqip')}
          />
          <br />
          <br />
          <b>
          ...
          <LazyLoadImage
            effect="blur"
            src={require('../../public/images/devblog/1/3.png?webp&url')}
            placeholderSrc={require('../../public/images/devblog/1/3.png?webp&lqip')}
          />
          <br />
          <br />
          ...
          <LazyLoadImage
            effect="blur"
            src={require('../../public/images/devblog/1/4.png?webp&url')}
            placeholderSrc={require('../../public/images/devblog/1/4.png?webp&lqip')}
          />
          <br />
          <br />
