...
import Title from '../public/images/other/developer-qna-title.png';
...
export default function DeveloperQandA({
  url,
  date,
}: {
  url:string,
    ...
    <div>
      <Head>
        <meta
          ...
          content={moment(date, 'MM-DD-YYYY').format('YYYY-M-D')}
        />
      </Head>
                  ...
                  },
                  {
                    ...
                    a: (
                      <>
                        ...
                        {' '}
                        <Link href="/devblog/13" prefetch={false}>Devblog 13</Link>
                        {' '}
