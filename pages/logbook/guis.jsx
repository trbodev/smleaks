...
export default function LogbookGUIs(page) {
            ...
            <div className="row row-eq-spacing-lg">
              <div className="col-lg-9">
                ...
                <div className="card">
                  ...
                  <figure>
                    <a id="logbook-gui" href="#" style={{ visibility: 'hidden' }} aria-hidden="true" />
                  ...
                  <figure>
                    <a id="waypoint-gui" href="#" style={{ visibility: 'hidden' }} aria-hidden="true" />
                  ...
                  <figure>
                    <a id="logbook-gui-mockup" href="#" style={{ visibility: 'hidden' }} aria-hidden="true" />
